...
interface VolumeChapterManagerProps {
  volumeId: string;
  volumeTitle: string;
  onClose: () => void;
}

const VolumeChapterManager = ({ volumeId, volumeTitle, onClose }: VolumeChapterManagerProps) => {
  ...
  const loadChapters = async () => {
    try {
      setIsLoading(true);
      // For volumes, we'll use the volume_id as book_id in the chapters table
      const data = await ChapterService.getBookChapters(volumeId);
      setChapters(data);
    } catch (error) {
  ...
  const handleAddChapter = async () => {
    try {
      ...
      const chapterData = {
        book_id: volumeId, // Using volume_id as book_id for volume chapters
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-900 rounded-lg w-full max-w-6xl h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div>
            <h2 className="text-2xl font-bold text-white">Volume Chapters Management</h2>
          ...
          <div className="w-2/3 p-6 overflow-y-auto">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <div className="text-white mb-2">No chapters yet</div>
                <div className="text-gray-400">Add your first chapter to get started</div>
              </div>
            ) : (
                  ...
                  <Card key={chapter.id} className="bg-gray-800 border-gray-700">
                    <CardContent className="p-4">
                      <div className="space-y-2">
                        ...
                        <h3 className="font-semibold text-white text-lg">{chapter.chapter_title}</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="chapter_number" className="text-white">Chapter Number</Label>
                      <Input
                        id="chapter_number"
                        type="number"
                  ...
                  <div>
                    <Label htmlFor="chapter_title" className="text-white">Chapter Title *</Label>
                    <Input
                      id="chapter_title"
                  ...
                  <div>
                    <Label htmlFor="chapter_description" className="text-white">Chapter Description</Label>
                    <Textarea
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="is_preview" className="text-white">Available for Preview</Label>
                  </div>

                  <div className="flex gap-2 pt-4">
                    <Button
                      onClick={editingChapterId ? handleUpdateChapter : handleAddChapter}
...
// Chapter Pages Manager Component (reuse from ChapterManager)
...
export default VolumeChapterManager;

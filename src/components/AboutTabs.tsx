  ...
  const tabData = {
    about: {
      ...
      content: {
        ...
        highlights: [
          "Romance that makes you smile in public (and pretend you're not).",
          "Fantasy so rich you'll lose yourself in its world.",
          "Isekai so good you'll check both ways for Truck-kun.",
          "Mystery that lingers in your mind long after the last page.",
          "Action that keeps your heart pounding."
        ],
    ...
    mission: {
      ...
      content: {
        ...
        highlights: [
          "True to the Original – We work side-by-side with creators to preserve their vision, voice, and emotional heartbeat.",
          "Authentic Localization – Cultural essence stays intact, so you feel the story exactly as it was meant to be felt. If a joke lands in Seoul or Tokyo, it should land in Seattle or Toronto.",
          "Passion-Driven Curation – We handpick stories worth treasuring, introducing you to worlds and characters you never knew you needed."
        ],
    ...
    team: {
      ...
      content: {
        ...
        highlights: [
          "Over 30 passionate individuals across time zones",
          "Offices in Los Angeles, USA and Bengaluru, India",
          "Over a year of behind-the-scenes work refining translations and layouts"
        ],
    ...
    imprints: {
      ...
      content: {
        ...
        subtext: "",
        highlights: [
          "BLUSH CLUB (2026) - Dedicated imprint for shounen ai, yaoi, and boy's love stories from across Asia, carefully localized in English for a global readership. From tender first loves to high-stakes romances set against fantastical backdrops, BLUSH CLUB curates series that celebrate love between men in all its forms.",
          "GLAM POP! (2027) - Imprint for shoujo ai, yuri, and girl's love series that span multiple genres, all brought to life in English with care and authenticity. GLAM POP! showcases stories of love, friendship, and connection between women, ranging from sweet slice-of-life romances to epic, otherworldly adventures.",
          "ONE & DONE (2026) - Designed for readers who want the full experience in one sitting. Specializing in standalone manga volumes that can be read and loved from start to finish in a single go, ONE & DONE is for the binge-reader who can't wait months for the next volume.",
          "E-NOVEL PRESS (2026) - Brings the best of Asian novels—from the original stories behind hit webcomics and manga to captivating new works—into the hands of English-speaking readers worldwide. Our catalogue spans romance, fantasy, action, mystery, horror, and sci-fi."
        ],
        additionalText: "",
        closingText: ""
      },
            ...
            <TabsContent key={key} value={key} className="mt-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div className={`transition-all duration-700 transform ${
                  ...
                  {data.content.highlights && data.content.highlights.length > 0 && (
